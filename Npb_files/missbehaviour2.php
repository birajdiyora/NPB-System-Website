        ...
        if(mysqli_num_rows($re)>0){
            ...
            while($row=mysqli_fetch_array($re)){
                ...
                $data.='
                    ...
                    <td>'.$row['course'].'</td>
                    <td>'.$row['adate'].'</td>
                    <td><input type="submit" data-bs-toggle="modal" data-bs-target="#modal1" value="Add" class="addbtn" id="'.$row['sid'].'" onclick="addstd('.$sid.');" style="color:white; background-color: #383838; border-radius:5px; width:70px;">
                    </tr>
