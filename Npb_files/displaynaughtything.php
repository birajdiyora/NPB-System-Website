...
/* 
        ...
        */
        ...
        #dte{
            ...
            #totp,#fpan,#deposite,#prayertot,#totmeet{
              font-weight:bold;
              font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;
            }
            #dna,#dna2{
            ...
            #fname,#sroomnu,#feenu,#sid,#course{
              font-size:20px;
            }
    </style>
</head>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Student Mistake Record</h5>
      ...
      <div class="container mb-5">
          <div class="row">
            ...
            <div class="row mt-2">
                 <label id="feenu"></label>
            </div>
          </div>
         </div>
         
<center><h3 class="mt-4">Panulty Record</h3></center>
            <div class="container">
                <div class="row">
                <div class="col-lg-1">
          ...
          <div class="col-lg-3">
                    <label id="deposite"></label>
          </div>
         
          </div>
          </div>
         <div class="container mt-3" id="cot2">
    <div class="table-responsive table-wrapper-scroll-y" id="ta1">
        <table class="table table-striped table" id="te">
            <thead class="">
              <tr class="bg-info text-white">
                <th scope="col">SR</th>
                <th scope="col">MISSBEHAVIOUR DETAIL</th>
                <th scope="col">PANULTY(₹)</th>
          ...
          <center><label id="dna">data Not Available</label></center>
        </div>
        <form method="post" id="fo">
</div>

<center><h3 class="mt-2">Prayer Record</h3></center>
<div class="container">
                <div class="row">
                <div class="col-lg-1">
          ...
          <div class="col-lg-3">
                    <label id="prayertot">  </label>
          </div>
          <div class="col-lg-5">
                   
          </div>
          <div class="col-lg-2">
                    <label id="totmeet"> </label>
          </div>
          <div class="col-lg-1">
...
<div class="container mt-3" id="cot2">
    <div class="table-responsive table-wrapper-scroll-y" id="tat2">
        <table class="table table-striped table" id="te">
            <thead class="">
              <tr class="bg-info text-white">
                <th scope="col">SR</th>
          ...
          <center><label id="dna2">data Not Available</label></center>
        </div>
        <form method="post" id="fo">
</div>
...
<script>
  ...
  function  addstd(sid){
          ...
          $.ajax({
            url:'displaynaughtything2.php',
            type:'POST',
             dataType: 'json',
            data:{sid:sid,c:1},
            success:function(data){
              $("#fname").html("<font style='font-weight:bold'>Full name</font> : "+data[0]+" "+data[1]+" "+data[2]);
              $("#sroomnu").html("<font style='font-weight:bold'>Room No</font> : "+data[3]);
              $("#photo").attr("src", "sphoto/"+data[4]);
              $("#course").html("<font style='font-weight:bold'>Course</font>&nbsp &nbsp  &nbsp: "+data[5]);
              $("#sid").html("<font style='font-weight:bold'>Sid</font>&nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp: "+data[6]);
              $("#feenu").html("<font style='font-weight:bold'>Fee No</font> &nbsp &nbsp: "+data[7]);
              if(data[4]==""){
                $("#photo").attr("src", "uprofile.png");
              }
              $("#sid").val(sid);
            }
          });
          ...
          $.ajax({
            ...
            data:{sid:sid,v:1},
            success:function(data){
              $("#totp").html("Total: "+data[0]);
              $("#fpan").html("Total Penalty: "+data[1]);
              $("#deposite").html("Deposited: "+data[2]);
              $("#prayertot").html("Total: "+data[3]);
              $("#totmeet").html("Meet: "+data[4]);
            }
          });
        }
