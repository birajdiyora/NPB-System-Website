...
session_start();
    ...
    while($row=mysqli_fetch_array($re)){
        $data['sername']=$row['sername'];  
        $data['studentname']=$row['studentname'];  
        $data['fathername']=$row['fathername'];  
        $data['roomnu']=$row['roomnu'];  
        $data['bad']=$row['bad'];  
        $data['course']=$row['course'];  
        $data['district']=$row['district'];  
        $data['taluko']=$row['taluko'];  
        $data['village']=$row['village'];
        $data['pincode']=$row['pincode'];    
        $data['studyin']=$row['studyin'];  
        $data['scname']=$row['scname'];  
        $data['smobilenu']=$row['smobilenu'];  
        $data['fmobilenu']=$row['fmobilenu'];  
        $data['studenttype']=$row['studenttype'];  
        $data['feenu']=$row['feenu'];  
        $data['feetype']=$row['feetype'];  
        $data['adate']=$row['adate'];  
        $data['idphoto']=$row['idphoto'];    
    }
?>
    ...
    <div class="container mt-5 pb-5">
        ...
        <div class="row p-4"id="name">
            ...
            <div class="col"id="name">
                ...
                <input type="text"name="sename" id="sename" class="text" placeholder="Firstname" value="<?php echo $data['sername'];?>">
                <div class="vm"></div>
            </div>
           
            <div class="col"id="name">
                <label>STUDENT NAME</label><br>
                <input type="text"name="sname" id="sname" class="text" placeholder="Studentname"  value="<?php echo $data['studentname'];?>">
                <div class="vm2"></div>
            </div>
            <div class="col"id="name">
                <label>FATHER NAME</label><br>
                <input type="text"name="fname" id="fname" class="text" placeholder="Fathername"  value="<?php echo $data['fathername'];?>"><br>
                <div class="vm3"></div>
            </div>
        ...
        <div class="row p-4">
            ...
            <div class="col-lg-3 p-4"id="add">
                ...
                <input type="text"name="village" id="village" placeholder="Student village"  value="<?php echo $data['village'];?>">
                <div class="vm4"></div>
            </div>
            <div class="col-lg-3 p-4"id="add">
                <label>TALUKA</label><br>
                <input type="text"name="taluka" id="taluko" placeholder="Student subdistrict"  value="<?php echo $data['taluko'];?>">
                <div class="vm5"></div>
            </div>
            <div class="col-lg-3 p-4" id="add">
                <label>CITY</label><br>
            ...
            <div class="col-lg-3 p-4"id="add">
                ...
                <input type="number" id="pincode" name="pincode"placeholder="Pincode"  value="<?php echo $data['pincode'];?>">
                <div class="vm17"></div>
            </div>
        </div>
        <div class="row p-4">
            ...
            <div class="col"id="con">
                ...
                <input type="number" maxlength="10" id="smo" placeholder="Sudent Mobile Number" name="stdmobileno"  value="<?php echo $data['smobilenu'];?>">
                <div class="vm6"></div>
            </div>
            <div class="col"id="con">
                <label>MOBILE NO.(FATHER)</label><br>
                <input type="number" maxlength="10" id="fmo" placeholder="Father Mobile Number" name="fathermobileno"  value="<?php echo $data['fmobilenu'];?>">
                <div class="vm7"></div>
            </div>
        </div>
        <div class="row p-4">
            ...
            <div class="col"id="study">
                <label>SCHOOL/COLLEGE/INSTITUTE</label><br>
                    <input type="text" id="scin" name="course" placeholder="School/college/institute name"  value="<?php echo $data['scname'];?>">
                    <div class="vm10"></div>
            </div>
        </div>
        <div class="row p-4">
            ...
            <div class="col" id="room">
                ...
                <font class="fo">OLD</font>&nbsp<input type="radio" class="stype" name="type1"value="old"  <?php if($data['studenttype']=="old"){echo "checked"; }?>>
                <font class="fo">NEW</font>&nbsp<input type="radio" class="stype" name="type1"value="new"  <?php if($data['studenttype']=="new"){echo "checked"; }?>>
                <div class="vm11"></div>
            </div>
            <div class="col"id="room">
                <label>ROOM NO.</label><br>
                <input type="number"id="roomnu" name="rommno"  value="<?php echo $data['roomnu'];?>">
                <div class="vm12"></div>
            </div>
            <div class="col"id="room">
                <label>BAD</label><br>
                <font class="fo">A</font><input type="radio" class="bad" name="bad1"value="a" <?php if($data['bad']=="a"){echo "checked"; }?>>
                <font class="fo">B</font><input type="radio" class="bad" name="bad1"value="b" <?php if($data['bad']=="b"){echo "checked"; }?>>
                <font class="fo">C</font><input type="radio" class="bad" name="bad1"value="c" <?php if($data['bad']=="c"){echo "checked"; }?>>
                <font class="fo">D</font><input type="radio" class="bad" name="bad1"value="d" <?php if($data['bad']=="d"){echo "checked"; }?>>
                <font class="fo">E</font><input type="radio" class="bad" name="bad1"value="e" <?php if($data['bad']=="e"){echo "checked"; }?>>
                <div class="vm13"></div>
            </div>
        </div>
        <div class="row p-4">
            ...
            <div class="col"id="oth">
                ...
                <input type="number" placeholder="Fee Receipt Number" id="feenu" class="fd" name="recieptno"  value="<?php echo $data['feenu'];?>">
                <div class="vm14"></div>
            </div>
            <div class="col"id="oth">
               <label>FEE TYPE:</label><br>
                <font class="fo">Full fee</font><input type="radio" class="feetype" name="feetype"value="full"  <?php if($data['feetype']=="full"){echo "checked"; }?>> &nbsp
                <font class="fo">Half fee(Loan)</font></label> <input type="radio" class="feetype" name="feetype"value="half"  <?php if($data['feetype']=="half"){echo "checked"; }?>>
                <div class="vm15"></div>
            </div>
            <div class="col"id="oth">
                <label>ADMISSION DATE</label><br>
                <?php 
                    $year=substr($data['adate'],6);
                    $month=substr($data['adate'],3,2);
                    $day=substr($data['adate'],0,2);
                     $date=$year.'-'.$month.'-'.$day;
                ?>
                <input type="date"name="date" id="adate" class="fd" value="<?php echo $date; ?>">
                <div class="vm16"></div>
            </div>
        </div>
        <div class="row p-4">
            <div class="col-lg-10 p-5"id="i">
                ...
                <input type="file"name="photo" id="photo" class="file" value="">
                <div class="vm18"></div>
            </div>
            <div class="col-lg-2 border border-dark">
                <image src="<?php echo 'sphoto/'.$data['idphoto'];?>" id="img"></image>
            </div>
        </div>
       <div class="row3">
           <div class="col">
           <input type="hidden" id="hi">
        <button type="submit" id="insert" class="btn btn-primary mrl-5" >UPDATE</button>
        <button type="clear"class="btn btn-danger  pr-10 btn-md" class="rebtn">RESET</button>
          ...
          <div" id="al2" class="">
                  Data is not updated successfuly 
          </div>
           </div>
       </div>
    </form>
